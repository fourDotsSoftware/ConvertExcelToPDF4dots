...
;copy translations end
  ...
  !define MUI_FILE "ConvertExcelToPDF4dots"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Convert Excel to PDF 4dots"
  !define PRODUCT_SHORTCUT "Convert Excel to PDF 4dots"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "office-image-extractor-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Convert Excel to PDF 4dots"
  OutFile "ConvertExcelToPDF4dotsSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Convert Excel to PDF 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Convert Excel to PDF 4dots - User's Manual.url.lnk" "$INSTDIR\Convert Excel to PDF 4dots - User's Manual.url" "" "$INSTDIR\Convert Excel to PDF 4dots - User's Manual.url" 0
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Convert Excel to PDF 4dots - User's Manual.chm";
  File "Convert Excel to PDF 4dots - User's Manual.url";
  File "ddb.dat"
  File "4dots Software Product CATALOG.url"
  File "license_agreement.rtf"             
  File "QuitOfficeApplications.exe"
  
  File "Excel.dll"
  File "ICSharpCode.SharpZipLib.dll"
  File "LumenWorks.Framework.IO.dll"
  File "C:\code\Misc\=Licenses\ICSharpCode.SharpZipLib_license.txt"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Convert Excel to PDF 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Convert Excel to PDF 4dots" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\AudioJoinerExpertShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Convert Excel to PDF 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Convert Excel to PDF 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/convert-excel-to-pdf/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/convert-excel-to-pdf/how-to-use.php?afterinstall=true"
FunctionEnd
