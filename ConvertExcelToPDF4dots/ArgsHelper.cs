...
{ 
    ...
    {        
        ...
        {
            string msg = "Batch convert Excel to PDF. PPTX to PDF. PPT to PDF.\n\n" +
            "ConvertExcelToPDF4dots.exe [[file|directory]]\n" +
            ...
            "/? : show help\n\n\n" +
            "Example :\n" +
            "ConvertExcelToPDF4dots.exe \"c:\\documents\\presentation.pptx\"\n\n" +
            "ConvertExcelToPDF4dots.exe \"c:\\documents\\presentations\"\n\n"+
            "ConvertExcelToPDF4dots.exe /importtext:\"c:\\documents\\list.txt\"\n\n" +
            "ConvertExcelToPDF4dots.exe /importexcel:\"c:\\documents\\list.xlsx\"\n\n";
        ...
        public static void ExecuteCommandLine()
        {
            ...
            try
            {
                ...
                */
                ...
                frmMain.Instance.tsbConvertExcelToPDF_Click(null, null);
