...
namespace ConvertExcelToPDF4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Convert Excel To PDF 4dots";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/ConvertExcelToPDF4dots/";
        public static string HelpURL = "https://www.4dots-software.com/convert-excel-to-pdf/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/convert-excel-to-pdf/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-convert-excel-to-pdf.php";
        public static string VersionURL = "http://cssspritestool.com/versions/convert-excel-to-pdf.txt";

        public static string TipText = TranslateHelper.Translate("Great application to Convert Excel to PDF !");        
        ...
        public static string OpenFilesFilter =
            ...
            //"Excel Files (*.ppt;*.pot;*.pps;*.pptx;*.pptm;*.potx;*.potm;*.ppsx;*.ppsm)|*.ppt;*.pot;*.pps;*.pptx;*.pptm;*.potx;*.potm;*.ppsx;*.ppsm|"
            " Excel Files (*.xls;*.xlt;*.xlsx;*.xlsm;*.xltx;*.xltm;*.xlsb;*.xlw)|*.xls;*.xlt;*.xlsx;*.xlsm;*.xltx;*.xltm;*.xlsb;*.xlw|"
            +"All Files (*.*)|*.*";
