...
namespace ConvertExcelToPDF4dots
{
    class OutputFolderHelper
    {
        ...
        {
            if (folder == TranslateHelper.Translate("Subfolder of Document")
                || folder == TranslateHelper.Translate("Overwrite Document")
                || folder == TranslateHelper.Translate("Same Folder of Document")
